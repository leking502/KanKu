...
#ifndef KANKU_KAN_DEVICE_HPP
#define KANKU_KAN_DEVICE_HPP
...
namespace leking {
    ...
    public:
        ...
        KanDevice(KanWindow &window);

        ~KanDevice();

        // Not copyable or movable
        KanDevice(const KanDevice &) = delete;

        void operator=(const KanDevice &) = delete;

        KanDevice(KanDevice &&) = delete;

        KanDevice &operator=(KanDevice &&) = delete;
